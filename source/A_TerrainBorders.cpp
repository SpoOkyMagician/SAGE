...
wxString AGE_Frame::GetTerrainBorderName(int index)
{
    if (dataset->TerrainBlock.TerrainBorders[index].Name.empty() && dataset->TerrainBlock.TerrainBorders[index].Name2.empty())
        return "Border " + boost::lexical_cast<std::string>(index);
...
wxString AGE_Frame::GetTerrainBorderTileTypeName(int index)
{
    ...
    default: return "Tile Type " + boost::lexical_cast<std::string>(index);
    }
}
...
{
    return "FC " + boost::lexical_cast<std::string>(dataset->TerrainBlock.TerrainBorders[BorderIDs.front()].Borders[BorderTileTypeIDs.front()][index].FrameCount)
        + ", A " + boost::lexical_cast<std::string>(dataset->TerrainBlock.TerrainBorders[BorderIDs.front()].Borders[BorderTileTypeIDs.front()][index].AngleCount)
        + ", SI " + boost::lexical_cast<std::string>(dataset->TerrainBlock.TerrainBorders[BorderIDs.front()].Borders[BorderTileTypeIDs.front()][index].ShapeID);
}

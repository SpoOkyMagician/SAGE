...
{
    return "Age " + boost::lexical_cast<std::string>(dataset->TechTree.TechTreeAges[index].ID);
}
...
void AGE_Frame::ListTTAgeUnknownItems()
{
    ...
    if (TTAgeIDs.size())
        ...
        {
            wxString Name = boost::lexical_cast<std::string>((short)dataset->TechTree.TechTreeAges[TTAgeIDs.front()].BuildingsPerZone[loop]);
            Name += " - " + boost::lexical_cast<std::string>((short)dataset->TechTree.TechTreeAges[TTAgeIDs.front()].GroupLengthPerZone[loop]);
            if (SearchMatches(" " + Name.Lower() + " "))
            {
...
void AGE_Frame::CreateTechTreeControls()
{
    ...
    TechTrees_Ages_Items.ModeCombo->Bind(wxEVT_COMBOBOX, [this](wxCommandEvent& event)
        {
            TechTrees_Ages_Items.Mode->ChangeValue(boost::lexical_cast<std::string>(TechTrees_Ages_Items.ModeCombo->GetSelection()));
    ...
    TechTrees_Buildings_Items.ModeCombo->Bind(wxEVT_COMBOBOX, [this](wxCommandEvent& event)
        {
            TechTrees_Buildings_Items.Mode->ChangeValue(boost::lexical_cast<std::string>(TechTrees_Buildings_Items.ModeCombo->GetSelection()));
    ...
    TechTrees_Units_Items.ModeCombo->Bind(wxEVT_COMBOBOX, [this](wxCommandEvent& event)
        {
            TechTrees_Units_Items.Mode->ChangeValue(boost::lexical_cast<std::string>(TechTrees_Units_Items.ModeCombo->GetSelection()));
    ...
    TechTrees_Researches_Items.ModeCombo->Bind(wxEVT_COMBOBOX, [this](wxCommandEvent& event)
        {
            TechTrees_Researches_Items.Mode->ChangeValue(boost::lexical_cast<std::string>(TechTrees_Researches_Items.ModeCombo->GetSelection()));
